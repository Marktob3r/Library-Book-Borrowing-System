        ...
        <div x-show="showDeleteModal" 
            ...
            <div class="bg-white rounded-xl p-8 max-w-md w-full shadow-2xl transform transition-all"
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Archive Book Record?</h3>
                    <p class="text-gray-500 mb-8">This will move the book to the archive. It will be permanently deleted after 30 days.</p>
                </div>
